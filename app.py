...
# ✅ If panel is empty, auto-try once more (cloud hiccup fix)
...
if panel.empty:
    st.warning(
        "Still no data. Click 'Load / Refresh data' again. "
        "If it keeps happening, try a smaller range like 2000:2023."
    )
    st.stop()
